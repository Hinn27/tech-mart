  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-[1400px] px-4 py-6">
        <Breadcrumbs items={[{ label: 'Máy tính bảng', href: '/may-tinh-bang' }]} className="mb-4" />
        ...
        >
          ...
          <div className="relative z-10 flex flex-col justify-center h-full px-8 md:px-12 text-white">
            <p className="text-sm md:text-base font-medium opacity-90 mb-1">Làm việc & Giải trí mọi lúc mọi nơi</p>
            <h1 className="text-3xl md:text-5xl font-extrabold text-balance">Máy Tính Bảng & iPad</h1>
            <p className="text-sm md:text-base opacity-80 mt-2 max-w-lg hidden sm:block">
              iPad Pro M4, Galaxy Tab S9 Ultra, Xiaomi Pad 6S Pro — Giá tốt nhất, bảo hành chính hãng.
            </p>
          </div>
        </div>
        ...
        {(!products || products.length === 0) ? (
          ...
          <ProductGrid products={products} categoryTitle="Máy tính bảng" />
        )}
      </main>
